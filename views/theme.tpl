...
<div class="layui-form" style="margin: 25px 0;" lay-filter="more-set-form">
    {if $showFooter}
        <div class="layui-form-item">
            <label class="set-item-label">显示页脚：</label>
