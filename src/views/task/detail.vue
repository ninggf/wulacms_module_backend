...
<script>
layui.use(['jquery', 'form', 'table', 'admin', 'laydate','element'], ($, form, table, admin, laydate) => {
  let element = layui.element, tpl = layui.laytpl, task_id = $('#task_id').val(),taskName=$('#taskName').val()
  tpl.config({
