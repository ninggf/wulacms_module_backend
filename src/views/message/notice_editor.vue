<template>
  <div data-area="800px" style="overflow: auto;height: 100%;width: 100%">
    <form class="layui-form layui-fluid layui-no-mb layui-no-pb" action="" lay-filter="noticeEditForm">
