...
class FileUploaderField extends FormField {
    ...
    protected function renderWidget($opts) {
        ...
        return '<div id="' . $id . '" data-name="' . $this->name . '" data-uploader="' . $url . '"' . $width . $skin . $height . $resize . $maxfs . $exts . $multi . $noWater . $readonly . $disabled . $auto . $local . ' data-value="' . $value . '"></div>';
    }
